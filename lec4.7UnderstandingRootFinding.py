# lec4.7UnderstandingRootFinding.py
...
# findRoot2 fixes this by first testing for negative number
...
# findRoot2 doesn't work for real numbers < 1, so need to fix this also
# For this case need to look for root from 0 to 1
